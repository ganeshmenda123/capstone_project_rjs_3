        ...
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Completed on september 17th, 2022
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
              Provides overall understanding of programming concepts,
              independent of specific technical roles. It provides a detailed
              overview of Frontend concepts.
            </p>
            <a
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            I want to be strong in web development and backend development.
Strong in design and integration with intuitive problems - problem
solving. Passionate in implementing innovative web pages.
            </p>
            <a
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <a
            href={require("../../assets/files/Ganesh resume.pdf")}
            download={"Ganesh resume"}
