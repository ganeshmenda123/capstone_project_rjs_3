        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/ganeshmenda123", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/accounts/onetap/?next=https%3A%2F%2Faccountscenter.instagram.com%2F%3F__coig_login%3D1",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/search/results/all/?keywords=ganesh%20menda&origin=GLOBAL_SEARCH_HEADER&sid=YjI",
                    "_blank"
                  )
                }
              >
